...
CREATE USER 'django_db'@'localhost' IDENTIFIED VIA mysql_native_password USING PASSWORD('VAjoIJyl(HPdmy(H');
...
CREATE USER 'django_db'@'127.0.0.1' IDENTIFIED VIA mysql_native_password USING PASSWORD('VAjoIJyl(HPdmy(H');
